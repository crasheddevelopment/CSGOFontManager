...
public class FXDisclaimer extends Application
{
    // Starts the application.
    public void start (Stage stage) throws IOException
    {
        // Initialize the variables.
        Parent root = FXMLLoader.load(getClass().getResource("/fxml/fx_disclaimer.fxml"));
        ...
        // Set up stage.
        stage.setTitle("CSGOFontManager | v" + StringUtils.VERSION + " | b" + StringUtils.BUILD);
